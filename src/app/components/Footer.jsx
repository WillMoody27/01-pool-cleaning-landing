            ...
            <div>
              ...
              <form className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 rounded text-white bg-gray-700 border border-gray-600 placeholder-gray-400 focus:outline-none focus:border-[#DC2626]"
                />
                <button
                  type="submit"
                  className="bg-[#DC2626] text-white px-4 py-2 rounded hover:bg-[#B91C1C] transition-colors"
                >
                  Subscribe
                </button>
              </form>
